...
public class Inventory {
    ...
    public void dispose() {
        ...
        if (this.itemsSuuTam != null) {
            for (Item it : this.itemsSuuTam) {
                it.dispose();
            }
            this.itemsSuuTam.clear();
        }
        this.itemsBody = null;
        this.itemsBag = null;
        this.itemsBox = null;
        this.itemsSuuTam = null;
