...
public class CombineService {
    ...
    public static final int NANG_CAP_BONG_TAI3 = 518;
    ...
    public static final int NANG_CHI_SO_BONG_TAI3 = 519;
        ...
        switch (type) {
            ...
            case NANG_CAP_BONG_TAI:
                return "Vào hành trang\nChọn bông tai Porata\nChọn mảnh bông tai để nâng cấp, Số lượng 9999 cái"
                        + "\nSau đó chọn 'Nâng cấp'";
            case NANG_CAP_BONG_TAI3:
                return "Vào hành trang\nChọn Bông tai Porata cấp 2 để nâng cấp"
                        + "\nYêu cầu: 20.000 Mảnh bông tai cấp 3, 99 Hồn bông tai, 2 Đá xanh lam"
                        + "\nSau đó chọn 'Nâng cấp'";
            case NANG_CHI_SO_BONG_TAI:
            ...
            case NANG_CHI_SO_BONG_TAI3:
                return "Vào hành trang\nChọn bông tai Porata\nChọn mảnh hồn porata số lượng 199"
                        + "\ncái và 2 đá xanh lam để nâng cấp.\nSau đó chọn 'Nâng cấp chỉ số'";
            case NANG_CAP_SAO_PHA_LE:
