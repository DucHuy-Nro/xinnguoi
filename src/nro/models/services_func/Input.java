            ...
            switch (player.idMark.getTypeInput()) {
                ...
                case TRADE_GEM -> {
                    ...
                    if (player.getSession().vnd < quantity) {
                        ...
                        int gemBonus = quantity * 3; // x3 ngọc
                        player.inventory.gem += gemBonus;
                        ...
                        int eventPointBonus = (quantity / 10000) * 50; // x3 điểm sự kiện
                        player.event.addEventPoint(eventPointBonus);

                        Service.gI().sendThongBao(player, "Bạn nhận thêm " + eventPointBonus + " điểm sự kiện!");
                        Service.gI().sendThongBao(player, "Đã nạp thành công. Bạn nhận được " + gemBonus + " ngọc và " + soLuongVe + " vé tặng ngọc.");
                    }
                }
