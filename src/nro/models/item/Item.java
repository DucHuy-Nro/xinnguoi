...
public class Item {
    ...
    public Item clone() {
        ...
        clone.isLock = this.isLock;
        clone.indexUI = this.indexUI;
        clone.itemOptions = new ArrayList<>();
        for (ItemOption io : this.itemOptions) {
            if (io != null) {
                clone.itemOptions.add(new ItemOption(io.optionTemplate, io.param));
            }
        }
        return clone;
    }
