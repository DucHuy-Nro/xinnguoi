...
public class ConstNpc {
    ...
    public static final int MABU_2H_OPEN = 1015;
    public static final int MABU_2H_NOT_OPEN = 1016;
    public static final int MABU_12H_OPEN = 1017;
    public static final int MABU_12H_NOT_OPEN = 1018;
    public static final int AVATAR = 564;
    public static final int VO_XEN_BO_HUNG = 9933;
