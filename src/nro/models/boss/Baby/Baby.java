...
public void reward(Player plKill) {
    ...
    int drop = 190; // Luôn rơi item ID 190
    ...
    if (Util.isTrue(5, 100)) {
        ...
        if (dropOptional >= 230 && dropOptional <= 280 && Util.isTrue(1, 100)) {
            optionalItemMap.options.add(new Item.ItemOption(251, Util.nextInt(0)));
            optionalItemMap.options.add(new Item.ItemOption(256, Util.nextInt(0)));
            optionalItemMap.options.add(new Item.ItemOption(257, Util.nextInt(0)));
            optionalItemMap.options.add(new Item.ItemOption(258, Util.nextInt(0)));
        }
