    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(50, 100)) {
            ...
            if (Util.isTrue(1, 100)) {
                itemMap.options.add(new Item.ItemOption(50, Util.nextInt(7, 15)));
                itemMap.options.add(new Item.ItemOption(77, Util.nextInt(7, 13)));
                itemMap.options.add(new Item.ItemOption(103, Util.nextInt(7, 13)));
                itemMap.options.add(new Item.ItemOption(101, Util.nextInt(10)));
                ...
                itemMap.options.add(new Item.ItemOption(101, Util.nextInt(10)));
                itemMap.options.add(new Item.ItemOption(30, 0));
                itemMap.options.add(new Item.ItemOption(93, Util.nextInt(2, 5))); // option 93 là thời hạn
            }
