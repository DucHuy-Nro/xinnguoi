...
//**************************************************************************
    ...
    public static final BossData SUPER_CUMBER = new BossData(
            ...
            new int[][]{
                ...
                {Skill.KHIEN_NANG_LUONG, 7, 30000},
                {Skill.KAMEJOKO, 7, 100},
                {Skill.GALICK, 7, 100}},
            //skill
            new String[]{}, //text chat 1
    ...
    public static final BossData[] BIET_DOI_HOA_TIEN = new BossData[] {
        new BossData(
        "Musashi",
        ConstPlayer.XAYDA,
        new short[]{1788, 1789, 1790, -1, -1, -1},
        20000,
        new int[]{70000000},
        new int[]{0, 1, 2, 3, 4, 5, 6, 7, 7, 8, 9, 10, 11, 12, 13, 14, 15},
        new int[][]{
            {Skill.GALICK, 7, 100},
            {Skill.DRAGON, 7, 100},
            {Skill.DEMON, 7, 100},
            ...
            {Skill.KAMEJOKO, 7, 100},
            {Skill.LIEN_HOAN, 7, 10000}},
        new String[]{"|-2|Cái đéo gì vậy?"},
        new String[]{"|-2|Cái đéo gì đang diễn ra vậy",
            "|-1|Nếu các người thành tâm muôn biết,thì chúng tôi sẵn lòng trả lời.\n"
            ...
            "|-1|Musashi",
            "|-1|Chúng tao là đội hỏa tiễn",
            "|-1|Bảo vệ dải ngân hà",
            "|-1|Một tương lai tươi sáng đang chờ đợi chúng tôi."},
        new String[]{"|-2|Adu biệt đội hỏa tiễn"},
        REST_15_M
        ),
        new BossData(
        "Kochiro",
        ConstPlayer.XAYDA,
        new short[]{1785, 1786, 1787, -1, -1, -1},
        20000,
        new int[]{70000000},
        new int[]{0, 1, 2, 3, 4, 5, 6, 7, 7, 8, 9, 10, 11, 12, 13, 14, 15},
        new int[][]{
        ...
        "Meowth",
        ConstPlayer.XAYDA,
        new short[]{1791, 1792, 1793, -1, -1, -1},
        20000,
        new int[]{70000000},
        new int[]{0, 1, 2, 3, 4, 5, 6, 7, 7, 8, 9, 10, 11, 12, 13, 14, 15},
        new int[][]{
